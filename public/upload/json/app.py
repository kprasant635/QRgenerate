...
# Opening JSON file
f = open('/var/www/qrcodegenerate.ntb.one/public/upload/json/datafileupload.json')
...
if os.path.exists("/var/www/qrcodegenerate.ntb.one/public/upload/json/datafileupload.json"):
  #os.remove("datafileupload.json")
  open('/var/www/qrcodegenerate.ntb.one/public/upload/json/datafileupload.json', 'w').close()
else:
